...
public class MybatisPlusGenerator {
    //生成文件所在项目路径
    private static String baseProjectPath = "D:\\idea\\demo\\src\\main\\java\\com\\example\\demo\\generator";

    //基本包名
    private static String basePackage="com.example.demo";
    //作者
    private static String authorName="Marcos-Lay";
    //要生成的表名
    ...
    private static String url = "jdbc:mysql://localhost:3306/test1?serverTimezone=UTC&characterEncoding=utf8&useUnicode=true&useSSL=false";
    private static String username = "root";
    private static String password = "malei123";
